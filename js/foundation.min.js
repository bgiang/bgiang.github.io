        ...
        function (t) {
            ...
            utils: {
                ...
                data_options: function (e, i) {
                    ...
                    for (r = (h || ":").split(";"), a = r.length; a--;) o = r[a].split(":"), o = [o[0], o.slice(1).join(":")], /true/i.test(o[1]) && (o[1] = !0), /false/i.test(o[1]) && (o[1] = !1), s(o[1]) && (o[1] = -1 === o[1].indexOf(".") ? parseInt(o[1], 10) : parseFloat(o[1])), 2 === o.length && o[0].length > 0 && (l[n(o[0])] = n(o[1]));
                    return l
                },
        ...
        check_validation_and_apply_styles: function (e) {
            ...
            for (n.data(this.attr_name(!0) + "-init") || {}; i--;) {
                var a, o, r = e[i][0],
                    ...
                    _ = [];
                if (r.getAttribute(this.add_namespace("data-equalto")) && (c = "equalTo"), a = h.is("label") ? h.parent() : h, u && l) _.push(this.valid_radio(r, l));
                else if (f && l) _.push(this.valid_checkbox(r, l));
                else if (c) {
                    for (var m = c.split(" "), v = !0, b = !0, x = 0; x < m.length; x++) o = this.settings.validators[m[x]].apply(this, [r, l, a]), _.push(o), b = o && v, v = o;
        ...
        events: function (e) {
            ...
            i.create(this.S(e)), s(this.scope).off(".fndtn.accordion").on("click.fndtn.accordion", "[" + this.attr_name() + "] > dd > a, [" + this.attr_name() + "] > li > a", function (e) {
                var n = s(this).closest("[" + i.attr_name() + "]"),
                    ...
                    h = d.filter("." + o.active_class);
                return e.preventDefault(), n.attr(i.attr_name()) && (d = d.add("[" + a + "] dd > ." + o.content_class + ", [" + a + "] li > ." + o.content_class), l = l.add("[" + a + "] dd, [" + a + "] li")), o.toggleable && r.is(h) ? (r.parent("dd, li").toggleClass(o.active_class, !1), r.toggleClass(o.active_class, !1), s(this).attr("aria-expanded", function (t, e) {
...
function (t, e, i, s) {
    ...
    Foundation.libs.clearing = {
        ...
        open: function (e, s, n) {
            ...
            function o(e) {
                var i = t(e);
                i.css("visibility", "visible"), i.trigger("imageVisible"), l.css("overflow", "hidden"), d.addClass("clearing-blackout"), h.addClass("clearing-container"), c.show(), this.fix_height(n).caption(r.S(".clearing-caption", c), r.S("img", n)).center_and_label(e, f).shift(s, n, function () {
            ...
            t("body").on("touchmove", function (t) {
                ...
                p = !0
            }), this.locked() || (c.trigger("open.fndtn.clearing"), g = this.load(e), g.interchange ? u.attr("data-interchange", g.interchange).foundation("interchange", "reflow") : u.attr("src", g.src).attr("data-interchange", ""), u.css("visibility", "hidden"), a.call(this))
        },
        close: function (e, s) {
            e.preventDefault();
        ...
        shift: function (t, e, i) {
            var s, n = e.parent(),
                ...
                d = e.outerWidth(),
                h = {};
            e.index() === a || /skip/.test(o) ? /skip/.test(o) && (s = e.index() - this.settings.up_count, this.lock(), s > 0 ? (h[r] = -(s * d), n.animate(h, 300, this.unlock())) : (h[r] = 0, n.animate(h, 300, this.unlock()))) : /left/.test(o) ? (this.lock(), h[r] = l + d, n.animate(h, 300, this.unlock())) : /right/.test(o) && (this.lock(), h[r] = l - d, n.animate(h, 300, this.unlock())), i()
        },
    ...
    var o = /\+/g,
        r = t.cookie = function (n, o, l) {
            if (void 0 !== o && !t.isFunction(o)) {
                ...
                return document.cookie = [e(n), "=", s(o), l.expires ? "; expires=" + l.expires.toUTCString() : "", l.path ? "; path=" + l.path : "", l.domain ? "; domain=" + l.domain : "", l.secure ? "; secure" : ""].join("")
            }
            for (var c = n ? void 0 : {}, u = document.cookie ? document.cookie.split("; ") : [], f = 0, p = u.length; p > f; f++) {
                var g = u[f].split("="),
                    _ = i(g.shift()),
                    m = g.join("=");
                if (n && n === _) {
            ...
            e.set_expedition_position(), i(e.scope).off(".magellan").on("click.fndtn.magellan", "[" + e.add_namespace("data-magellan-arrival") + "] a[href*=#]", function (i) {
                ...
                if (s && n && a) {
                    ...
                    var r = t(this).closest("[" + e.attr_name() + "]"),
                        ...
                        h = t('a[name="' + d + '"]');
                    0 === h.length && (h = t("#" + d));
                    var c = h.offset().top - l.destination_threshold + 1;
                    l.offset_by_height && (c -= r.outerHeight()), t("html, body").stop().animate({
                        scrollTop: c
            ...
            if (s) {
                ...
                if (d.animate || (this.locked = !1), d.pop) {
                    ...
                    return setTimeout(function () {
                        return i.css(s).animate(h, a.animation_speed, "linear", function () {
    ...
    Foundation.libs.slider = {
        ...
        set_ui: function (e, i) {
            var s = t.data(e[0], "settings"),
                ...
                l = 100 * o,
                d = e.parent(),
                h = e.parent().children("input[type=hidden]");
...
function (t, e, i, s) {
    ...
    Foundation.libs.tab = {
        ...
        toggle_active_tab: function (n, a) {
            ...
            h.data("tab-content") && (c = "#" + h.data("tab-content").split("#")[1], u = r(c)), p.deep_linking && (p.scroll_to_content ? (_(a || c), a == s || a == c ? n.parent()[0].scrollIntoView() : r(c)[0].scrollIntoView()) : _(a != s ? "fndtn-" + a.replace("#", "") : "fndtn-" + c.replace("#", ""))), n.addClass(p.active_class).triggerHandler("opened"), d.attr({
                "aria-selected": "true",
                tabindex: 0
